        ...
        <div className="flex">
          <li className="bg-[#202938]  md:w-[340px] h-[340px] flex justify-center items-center ">
            <img
              src={Heroimage3}
              alt="DetailsImage"
              className="w-56 h-72 object-contain p-4 md:p-0"
            />
          </li>
        </div>
        <div className="flex flex-col items-start gap-10  text-white">
          <div className=" flex flex-col gap-3">
            ...
            <p>
              ...
              numquam fugiat excepturi provident accusamus quibusdam blanditiis
              optio, eum nemo minus asperiores sed ipsam ratione, quisquam
              consectetur unde cumque! Non, minima.
            </p>
          </div>
          <div>
            <h4>Current Price</h4>
